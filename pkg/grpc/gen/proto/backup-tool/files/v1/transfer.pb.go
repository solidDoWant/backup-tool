...
type CopyFilesRequest struct {
	...
	xxx_hidden_Source      *string                `protobuf:"bytes,1,opt,name=source" json:"source,omitempty"`
	xxx_hidden_Dest        *string                `protobuf:"bytes,2,opt,name=dest" json:"dest,omitempty"`
