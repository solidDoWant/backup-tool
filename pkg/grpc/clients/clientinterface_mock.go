...
func (_m *MockClientInterface) S3() s3.Runtime {
	...
	var r0 s3.Runtime
	if rf, ok := ret.Get(0).(func() s3.Runtime); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(s3.Runtime)
		}
	}
...
func (_e *MockClientInterface_Expecter) S3() *MockClientInterface_S3_Call {
	return &MockClientInterface_S3_Call{Call: _e.mock.On("S3")}
}

func (_c *MockClientInterface_S3_Call) Run(run func()) *MockClientInterface_S3_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockClientInterface_S3_Call) Return(_a0 s3.Runtime) *MockClientInterface_S3_Call {
	_c.Call.Return(_a0)
	return _c
}
