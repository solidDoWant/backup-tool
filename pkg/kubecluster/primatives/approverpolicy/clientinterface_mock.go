...
func (_m *MockClientInterface) CreateCertificateRequestPolicy(ctx context.Context, name string, spec v1alpha1.CertificateRequestPolicySpec, opts CreateCertificateRequestPolicyOptions) (*v1alpha1.CertificateRequestPolicy, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, v1alpha1.CertificateRequestPolicySpec, CreateCertificateRequestPolicyOptions) (*v1alpha1.CertificateRequestPolicy, error)); ok {
		return rf(ctx, name, spec, opts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, v1alpha1.CertificateRequestPolicySpec, CreateCertificateRequestPolicyOptions) *v1alpha1.CertificateRequestPolicy); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, v1alpha1.CertificateRequestPolicySpec, CreateCertificateRequestPolicyOptions) error); ok {
...
func (_c *MockClientInterface_CreateCertificateRequestPolicy_Call) Run(run func(ctx context.Context, name string, spec v1alpha1.CertificateRequestPolicySpec, opts CreateCertificateRequestPolicyOptions)) *MockClientInterface_CreateCertificateRequestPolicy_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(v1alpha1.CertificateRequestPolicySpec), args[3].(CreateCertificateRequestPolicyOptions))
	})
	return _c
}
...
func (_c *MockClientInterface_CreateCertificateRequestPolicy_Call) RunAndReturn(run func(context.Context, string, v1alpha1.CertificateRequestPolicySpec, CreateCertificateRequestPolicyOptions) (*v1alpha1.CertificateRequestPolicy, error)) *MockClientInterface_CreateCertificateRequestPolicy_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteCertificateRequestPolicy provides a mock function with given fields: ctx, name
func (_m *MockClientInterface) DeleteCertificateRequestPolicy(ctx context.Context, name string) error {
...
func (_c *MockClientInterface_DeleteCertificateRequestPolicy_Call) Run(run func(ctx context.Context, name string)) *MockClientInterface_DeleteCertificateRequestPolicy_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClientInterface_DeleteCertificateRequestPolicy_Call) RunAndReturn(run func(context.Context, string) error) *MockClientInterface_DeleteCertificateRequestPolicy_Call {
	_c.Call.Return(run)
	return _c
}

// WaitForReadyCertificateRequestPolicy provides a mock function with given fields: ctx, name, opts
func (_m *MockClientInterface) WaitForReadyCertificateRequestPolicy(ctx context.Context, name string, opts WaitForReadyCertificateRequestPolicyOpts) (*v1alpha1.CertificateRequestPolicy, error) {
	...
	var r0 *v1alpha1.CertificateRequestPolicy
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, WaitForReadyCertificateRequestPolicyOpts) (*v1alpha1.CertificateRequestPolicy, error)); ok {
		return rf(ctx, name, opts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, WaitForReadyCertificateRequestPolicyOpts) *v1alpha1.CertificateRequestPolicy); ok {
		r0 = rf(ctx, name, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1alpha1.CertificateRequestPolicy)
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, WaitForReadyCertificateRequestPolicyOpts) error); ok {
		r1 = rf(ctx, name, opts)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockClientInterface_WaitForReadyCertificateRequestPolicy_Call) Run(run func(ctx context.Context, name string, opts WaitForReadyCertificateRequestPolicyOpts)) *MockClientInterface_WaitForReadyCertificateRequestPolicy_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(WaitForReadyCertificateRequestPolicyOpts))
	})
	return _c
}
...
func (_c *MockClientInterface_WaitForReadyCertificateRequestPolicy_Call) RunAndReturn(run func(context.Context, string, WaitForReadyCertificateRequestPolicyOpts) (*v1alpha1.CertificateRequestPolicy, error)) *MockClientInterface_WaitForReadyCertificateRequestPolicy_Call {
	_c.Call.Return(run)
	return _c
}
