...
func (c *PostgresqlV1Client) Publications(namespace string) PublicationInterface {
	return newPublications(c, namespace)
}
...
func (c *PostgresqlV1Client) Subscriptions(namespace string) SubscriptionInterface {
