...
func (_m *MockClientInterface) SnapshotVolume(_a0 *contexts.Context, _a1 string, _a2 string, _a3 SnapshotVolumeOptions) (*v1.VolumeSnapshot, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*contexts.Context, string, string, SnapshotVolumeOptions) (*v1.VolumeSnapshot, error)); ok {
		return rf(_a0, _a1, _a2, _a3)
	}
	if rf, ok := ret.Get(0).(func(*contexts.Context, string, string, SnapshotVolumeOptions) *v1.VolumeSnapshot); ok {
...
func (_c *MockClientInterface_SnapshotVolume_Call) RunAndReturn(run func(*contexts.Context, string, string, SnapshotVolumeOptions) (*v1.VolumeSnapshot, error)) *MockClientInterface_SnapshotVolume_Call {
	_c.Call.Return(run)
	return _c
}

// WaitForReadySnapshot provides a mock function with given fields: ctx, namespace, name, opts
func (_m *MockClientInterface) WaitForReadySnapshot(ctx *contexts.Context, namespace string, name string, opts WaitForReadySnapshotOpts) (*v1.VolumeSnapshot, error) {
	...
	var r0 *v1.VolumeSnapshot
	var r1 error
	if rf, ok := ret.Get(0).(func(*contexts.Context, string, string, WaitForReadySnapshotOpts) (*v1.VolumeSnapshot, error)); ok {
		return rf(ctx, namespace, name, opts)
	}
	if rf, ok := ret.Get(0).(func(*contexts.Context, string, string, WaitForReadySnapshotOpts) *v1.VolumeSnapshot); ok {
...
func (_c *MockClientInterface_WaitForReadySnapshot_Call) RunAndReturn(run func(*contexts.Context, string, string, WaitForReadySnapshotOpts) (*v1.VolumeSnapshot, error)) *MockClientInterface_WaitForReadySnapshot_Call {
	_c.Call.Return(run)
	return _c
}
