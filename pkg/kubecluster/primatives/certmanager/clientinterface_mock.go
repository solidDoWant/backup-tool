...
func (_m *MockClientInterface) CreateCertificate(ctx *contexts.Context, namespace string, name string, issuerRef v1.IssuerReference, opts CreateCertificateOptions) (*certmanagerv1.Certificate, error) {
	ret := _m.Called(ctx, namespace, name, issuerRef, opts)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*contexts.Context, string, string, v1.IssuerReference, CreateCertificateOptions) (*certmanagerv1.Certificate, error)); ok {
		return rf(ctx, namespace, name, issuerRef, opts)
	}
	if rf, ok := ret.Get(0).(func(*contexts.Context, string, string, v1.IssuerReference, CreateCertificateOptions) *certmanagerv1.Certificate); ok {
		r0 = rf(ctx, namespace, name, issuerRef, opts)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*contexts.Context, string, string, v1.IssuerReference, CreateCertificateOptions) error); ok {
		r1 = rf(ctx, namespace, name, issuerRef, opts)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockClientInterface_Expecter) CreateCertificate(ctx interface{}, namespace interface{}, name interface{}, issuerRef interface{}, opts interface{}) *MockClientInterface_CreateCertificate_Call {
	return &MockClientInterface_CreateCertificate_Call{Call: _e.mock.On("CreateCertificate", ctx, namespace, name, issuerRef, opts)}
}
...
func (_c *MockClientInterface_CreateCertificate_Call) Run(run func(ctx *contexts.Context, namespace string, name string, issuerRef v1.IssuerReference, opts CreateCertificateOptions)) *MockClientInterface_CreateCertificate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*contexts.Context), args[1].(string), args[2].(string), args[3].(v1.IssuerReference), args[4].(CreateCertificateOptions))
	})
	return _c
}
...
func (_m *MockClientInterface) CreateIssuer(ctx *contexts.Context, namespace string, name string, config certmanagerv1.IssuerConfig, opts CreateIssuerOptions) (*certmanagerv1.Issuer, error) {
	ret := _m.Called(ctx, namespace, name, config, opts)

	if len(ret) == 0 {
		panic("no return value specified for CreateIssuer")
	}

	var r0 *certmanagerv1.Issuer
	var r1 error
	if rf, ok := ret.Get(0).(func(*contexts.Context, string, string, certmanagerv1.IssuerConfig, CreateIssuerOptions) (*certmanagerv1.Issuer, error)); ok {
		return rf(ctx, namespace, name, config, opts)
	}
	if rf, ok := ret.Get(0).(func(*contexts.Context, string, string, certmanagerv1.IssuerConfig, CreateIssuerOptions) *certmanagerv1.Issuer); ok {
		r0 = rf(ctx, namespace, name, config, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*certmanagerv1.Issuer)
		}
	}

	if rf, ok := ret.Get(1).(func(*contexts.Context, string, string, certmanagerv1.IssuerConfig, CreateIssuerOptions) error); ok {
		r1 = rf(ctx, namespace, name, config, opts)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockClientInterface_Expecter) CreateIssuer(ctx interface{}, namespace interface{}, name interface{}, config interface{}, opts interface{}) *MockClientInterface_CreateIssuer_Call {
	return &MockClientInterface_CreateIssuer_Call{Call: _e.mock.On("CreateIssuer", ctx, namespace, name, config, opts)}
}
...
func (_c *MockClientInterface_CreateIssuer_Call) Run(run func(ctx *contexts.Context, namespace string, name string, config certmanagerv1.IssuerConfig, opts CreateIssuerOptions)) *MockClientInterface_CreateIssuer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*contexts.Context), args[1].(string), args[2].(string), args[3].(certmanagerv1.IssuerConfig), args[4].(CreateIssuerOptions))
	})
	return _c
}
...
func (_m *MockClientInterface) GetCertificate(ctx *contexts.Context, namespace string, name string) (*certmanagerv1.Certificate, error) {
	...
	var r0 *certmanagerv1.Certificate
	var r1 error
	if rf, ok := ret.Get(0).(func(*contexts.Context, string, string) (*certmanagerv1.Certificate, error)); ok {
		return rf(ctx, namespace, name)
	}
	if rf, ok := ret.Get(0).(func(*contexts.Context, string, string) *certmanagerv1.Certificate); ok {
		r0 = rf(ctx, namespace, name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*certmanagerv1.Certificate)
...
func (_m *MockClientInterface) GetClusterIssuer(ctx *contexts.Context, name string) (*certmanagerv1.ClusterIssuer, error) {
	...
	var r0 *certmanagerv1.ClusterIssuer
	var r1 error
	if rf, ok := ret.Get(0).(func(*contexts.Context, string) (*certmanagerv1.ClusterIssuer, error)); ok {
		return rf(ctx, name)
	}
	if rf, ok := ret.Get(0).(func(*contexts.Context, string) *certmanagerv1.ClusterIssuer); ok {
		r0 = rf(ctx, name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*certmanagerv1.ClusterIssuer)
		}
	}
...
func (_m *MockClientInterface) GetIssuer(ctx *contexts.Context, namespace string, name string) (*certmanagerv1.Issuer, error) {
	...
	var r0 *certmanagerv1.Issuer
	var r1 error
	if rf, ok := ret.Get(0).(func(*contexts.Context, string, string) (*certmanagerv1.Issuer, error)); ok {
		return rf(ctx, namespace, name)
	}
	if rf, ok := ret.Get(0).(func(*contexts.Context, string, string) *certmanagerv1.Issuer); ok {
		r0 = rf(ctx, namespace, name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*certmanagerv1.Issuer)
...
func (_m *MockClientInterface) WaitForReadyCertificate(ctx *contexts.Context, namespace string, name string, opts WaitForReadyCertificateOpts) (*certmanagerv1.Certificate, error) {
	...
	var r0 *certmanagerv1.Certificate
	var r1 error
	if rf, ok := ret.Get(0).(func(*contexts.Context, string, string, WaitForReadyCertificateOpts) (*certmanagerv1.Certificate, error)); ok {
		return rf(ctx, namespace, name, opts)
	}
	if rf, ok := ret.Get(0).(func(*contexts.Context, string, string, WaitForReadyCertificateOpts) *certmanagerv1.Certificate); ok {
...
func (_m *MockClientInterface) WaitForReadyIssuer(ctx *contexts.Context, namespace string, name string, opts WaitForReadyIssuerOpts) (*certmanagerv1.Issuer, error) {
	...
	var r0 *certmanagerv1.Issuer
	var r1 error
	if rf, ok := ret.Get(0).(func(*contexts.Context, string, string, WaitForReadyIssuerOpts) (*certmanagerv1.Issuer, error)); ok {
		return rf(ctx, namespace, name, opts)
	}
	if rf, ok := ret.Get(0).(func(*contexts.Context, string, string, WaitForReadyIssuerOpts) *certmanagerv1.Issuer); ok {
		r0 = rf(ctx, namespace, name, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*certmanagerv1.Issuer)
