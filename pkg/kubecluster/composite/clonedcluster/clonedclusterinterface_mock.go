...
// GetCertificateRequestPolicies provides a mock function with no fields
func (_m *MockClonedClusterInterface) GetCertificateRequestPolicies() []*v1alpha1.CertificateRequestPolicy {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetCertificateRequestPolicies")
	}
...
// MockClonedClusterInterface_GetCertificateRequestPolicies_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetCertificateRequestPolicies'
type MockClonedClusterInterface_GetCertificateRequestPolicies_Call struct {
	*mock.Call
}

// GetCertificateRequestPolicies is a helper method to define mock.On call
func (_e *MockClonedClusterInterface_Expecter) GetCertificateRequestPolicies() *MockClonedClusterInterface_GetCertificateRequestPolicies_Call {
	return &MockClonedClusterInterface_GetCertificateRequestPolicies_Call{Call: _e.mock.On("GetCertificateRequestPolicies")}
}

func (_c *MockClonedClusterInterface_GetCertificateRequestPolicies_Call) Run(run func()) *MockClonedClusterInterface_GetCertificateRequestPolicies_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockClonedClusterInterface_GetCertificateRequestPolicies_Call) Return(_a0 []*v1alpha1.CertificateRequestPolicy) *MockClonedClusterInterface_GetCertificateRequestPolicies_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClonedClusterInterface_GetCertificateRequestPolicies_Call) RunAndReturn(run func() []*v1alpha1.CertificateRequestPolicy) *MockClonedClusterInterface_GetCertificateRequestPolicies_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetSelfSignedIssuer provides a mock function with no fields
func (_m *MockClonedClusterInterface) GetSelfSignedIssuer() *v1.Issuer {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetSelfSignedIssuer")
	}
...
// MockClonedClusterInterface_GetSelfSignedIssuer_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetSelfSignedIssuer'
type MockClonedClusterInterface_GetSelfSignedIssuer_Call struct {
	*mock.Call
}

// GetSelfSignedIssuer is a helper method to define mock.On call
func (_e *MockClonedClusterInterface_Expecter) GetSelfSignedIssuer() *MockClonedClusterInterface_GetSelfSignedIssuer_Call {
	return &MockClonedClusterInterface_GetSelfSignedIssuer_Call{Call: _e.mock.On("GetSelfSignedIssuer")}
}

func (_c *MockClonedClusterInterface_GetSelfSignedIssuer_Call) Run(run func()) *MockClonedClusterInterface_GetSelfSignedIssuer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockClonedClusterInterface_GetSelfSignedIssuer_Call) Return(_a0 *v1.Issuer) *MockClonedClusterInterface_GetSelfSignedIssuer_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClonedClusterInterface_GetSelfSignedIssuer_Call) RunAndReturn(run func() *v1.Issuer) *MockClonedClusterInterface_GetSelfSignedIssuer_Call {
	_c.Call.Return(run)
	return _c
}
...
// addCertificateRequestPolicy provides a mock function with given fields: crp
func (_m *MockClonedClusterInterface) addCertificateRequestPolicy(crp *v1alpha1.CertificateRequestPolicy) {
	_m.Called(crp)
}

// MockClonedClusterInterface_addCertificateRequestPolicy_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'addCertificateRequestPolicy'
type MockClonedClusterInterface_addCertificateRequestPolicy_Call struct {
	*mock.Call
}

// addCertificateRequestPolicy is a helper method to define mock.On call
//   - crp *v1alpha1.CertificateRequestPolicy
func (_e *MockClonedClusterInterface_Expecter) addCertificateRequestPolicy(crp interface{}) *MockClonedClusterInterface_addCertificateRequestPolicy_Call {
	return &MockClonedClusterInterface_addCertificateRequestPolicy_Call{Call: _e.mock.On("addCertificateRequestPolicy", crp)}
}

func (_c *MockClonedClusterInterface_addCertificateRequestPolicy_Call) Run(run func(crp *v1alpha1.CertificateRequestPolicy)) *MockClonedClusterInterface_addCertificateRequestPolicy_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClonedClusterInterface_addCertificateRequestPolicy_Call) Return() *MockClonedClusterInterface_addCertificateRequestPolicy_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockClonedClusterInterface_addCertificateRequestPolicy_Call) RunAndReturn(run func(*v1alpha1.CertificateRequestPolicy)) *MockClonedClusterInterface_addCertificateRequestPolicy_Call {
	_c.Run(run)
	return _c
}
...
// setSelfSignedIssuer provides a mock function with given fields: issuer
func (_m *MockClonedClusterInterface) setSelfSignedIssuer(issuer *v1.Issuer) {
	_m.Called(issuer)
}

// MockClonedClusterInterface_setSelfSignedIssuer_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'setSelfSignedIssuer'
type MockClonedClusterInterface_setSelfSignedIssuer_Call struct {
	*mock.Call
}

// setSelfSignedIssuer is a helper method to define mock.On call
//   - issuer *v1.Issuer
func (_e *MockClonedClusterInterface_Expecter) setSelfSignedIssuer(issuer interface{}) *MockClonedClusterInterface_setSelfSignedIssuer_Call {
	return &MockClonedClusterInterface_setSelfSignedIssuer_Call{Call: _e.mock.On("setSelfSignedIssuer", issuer)}
}

func (_c *MockClonedClusterInterface_setSelfSignedIssuer_Call) Run(run func(issuer *v1.Issuer)) *MockClonedClusterInterface_setSelfSignedIssuer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*v1.Issuer))
	})
	return _c
...
func (_c *MockClonedClusterInterface_setSelfSignedIssuer_Call) Return() *MockClonedClusterInterface_setSelfSignedIssuer_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockClonedClusterInterface_setSelfSignedIssuer_Call) RunAndReturn(run func(*v1.Issuer)) *MockClonedClusterInterface_setSelfSignedIssuer_Call {
	_c.Run(run)
	return _c
}
