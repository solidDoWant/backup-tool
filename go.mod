module github.com/solidDoWant/backup-tool
...
// v1.5.0 has a massive breaking change - it remove the `trail` package, removing support for
// error propagation over gRPC. Pin to the latest 1.4.1 version until I build a replacement.
replace github.com/gravitational/trace => github.com/gravitational/trace v1.4.1
